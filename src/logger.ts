...
export class Logger {
  ...
  debug(msg: string, obj?: any) {
    ...
    if (obj) {
      ...
      console.debug(
        chalk.bgYellow.black(`DEBUG-[${dateFormat(Date.now(), 'yyyy.mm.dd hh:MM:ss')}]`),
        `- ${chalk.inverse(this.TAG)}: ${msg}`,
        obj,
      );
    } else {
      console.debug(
  ...
  info(msg: string, obj?: any) {
    ...
    if (obj) {
      // tslint:disable-next-line:max-line-length
      console.info(
        chalk.bgGreen.black(`INFO -[${dateFormat(Date.now(), 'yyyy.mm.dd hh:MM:ss')}]`),
        `- ${chalk.inverse(this.TAG)}: ${msg}`,
        obj,
      );
    } else {
  ...
  log(msg: string, obj?: any) {
    ...
    if (obj) {
      console.log(
        chalk.bgBlue(`LOG  -[${dateFormat(Date.now(), 'yyyy.mm.dd hh:MM:ss')}]`),
        `- ${chalk.inverse(this.TAG)}: ${msg}`,
        obj,
      );
    } else {
  ...
  warn(msg: string, obj?: any) {
    ...
    if (obj) {
      // tslint:disable-next-line:max-line-length
      console.warn(
        chalk.bgYellow.black(`WARN -[${dateFormat(Date.now(), 'yyyy.mm.dd hh:MM:ss')}]`),
        `- ${chalk.inverse(this.TAG)}: ${msg}`,
        obj,
      );
    } else {
  ...
  error(msg: string, obj?: any) {
    ...
    if (obj) {
      // tslint:disable-next-line:max-line-length
      console.error(
        chalk.bgRed.black(`ERROR-[${dateFormat(Date.now(), 'yyyy.mm.dd hh:MM:ss')}]`),
        `- ${chalk.inverse(this.TAG)}: ${msg}`,
        obj,
      );
    } else {
